...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_TODO_TAG = "CREATE TABLE IF NOT EXISTS "
...
//        db.execSQL("DROP TABLE IF EXISTS " + TABLE_TODO_TAG);
        ...
        if (newVersion > oldVersion) {
            db.execSQL("ALTER TABLE todos ADD COLUMN themCot3 TEXT");
            Log.d(TAG, "onUpgrade: Add Column");
        }
        // create new tables
        onCreate(db);
    }
    ...
    public ArrayList<String> getAllColumnsTodo() {
        ...
        Collections.addAll(allColumns, allColumn);
    ...
    public long createToDo(Todo todo, long[] tag_ids) {
        ...
        values.put("themCot3", todo.getThemCot3());
    ...
    public List<Todo> getAllToDos() {
        ...
        if (c.moveToFirst()) {
            do {
                ...
                td.setNote((c.getString(c.getColumnIndex(KEY_TODO))));
                td.setCreatedAt(c.getString(c.getColumnIndex(KEY_CREATED_AT)));
                td.setThemCot3(c.getString(c.getColumnIndex("themCot3")));
