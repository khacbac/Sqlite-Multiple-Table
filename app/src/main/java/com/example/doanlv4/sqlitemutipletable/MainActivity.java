...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Todo todo8 = new Todo("Don't forget to call MOM", 0, "2017","Them 1");
        Todo todo9 = new Todo("Collect money from John", 0,"2017","Them 2");

        Todo todo10 = new Todo("Post new Article", 0,"2017","Them 3");
        Todo todo11 = new Todo("Take database backup", 0,"2017","Them 4");
...
//            Log.d("ToDo", todo.getNote());
            Log.d(TAG, "onCreate: get ALl Todos Note =" + todo.getNote());
            Log.d(TAG, "onCreate: get ALl Todos Create at =" + todo.getCreated_at());
            Log.d(TAG, "onCreate: get ALl Todos Them cot =" + todo.getThemCot3());
        }
        ...
        // Get all column cua bang todo.
        ArrayList<String> listColumns = db.getAllColumnsTodo();
        for (String column : listColumns) {
            Log.d(TAG, "onCreate: column name = " + column);
        }
